...
import UploadSingleImage from "../edit/UploadSingleImage";
import { UploadMultipleImages } from "../edit/UploadMultipleImages";
  ...
  return (
    <div className="flex-1 rounded-lg bg-white px-4 py-6 shadow-sm sm:px-6">
      <div className="h-full min-h-[500px] w-full">
        <div className="mb-4 text-lg font-semibold">انشاء مزاد جديد</div>
        <Form {...form}>
          <form
